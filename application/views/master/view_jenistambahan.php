        ...
        <div class="box">
            <div class="box-header">
                <p style="text-align: right;">
                    <a href="<?php echo base_url('master/form_jenistambahan') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah</a>
...
$(document).ready(function() {
    $('#tabelku').DataTable({
        ...
        "serverSide": true,
        "ajax":{
                url :"<?php echo base_url('master/datajenistambahan')?>",
                type: "post", 
            },
    });
});
...
function tampilform(str) {
    $.ajax({
        url:"<?php echo base_url('master/form_jenistambahan') ?>",
        cache:false,
        type:"POST",
        data:{id:str},
...
function hapusdata(str) {
    $.ajax({
        url:"<?php echo base_url('master/hapus_jenistambahan') ?>",
        cache:false,
        type:"POST",
        data:{id:str},
            success:function(result){
